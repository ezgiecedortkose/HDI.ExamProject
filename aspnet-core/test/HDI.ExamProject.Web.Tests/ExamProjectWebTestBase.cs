...
{
    public abstract class ExamProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ExamProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ExamProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ExamProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ExamProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ExamProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ExamProjectDbContext, Task<T>> func)
        {
            T result;
